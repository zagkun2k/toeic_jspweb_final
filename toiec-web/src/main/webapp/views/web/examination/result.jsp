...
<div class="image group">
    <div class="grid news_desc">
        ...
        <br/>
        <a href="/toiec_web_war/danh-sach-bai-thi-tong-hop.html" class="btn btn-primary" type="button">Trở lại danh sách</a>
    </div>
    <div class="grid images_3_of_1">
        ...
        <br/>
        <a href="/toiec_web_war/bai-thi-tong-hop.html?examinationId=${items.examinationId}" class="btn btn-primary" type="button">Làm lại bài thi</a>
