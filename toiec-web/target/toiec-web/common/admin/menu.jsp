...
<c:url value="/admin-list-user.html" var="userListManageUrl">
    <c:param name="urlType" value="url_list"/>
</c:url>

<c:url value="/admin-exercise-upload" var="exerciseUploadUrl"/>
    ...
    <ul class="nav nav-list">
        <li class="">
            <a href="#" class="dropdown-toggle">
                ...
                <fmt:message key="label.guideline.listen.management" bundle="${lang}"/>
