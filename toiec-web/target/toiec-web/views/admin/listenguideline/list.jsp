...
<div class="main-content">
    <div class="main-content-inner">
        ...
        <div class="page-content">
            <div class="row">
                <div class="col-xs-12">
<%--                    <a href="${listenGuidelineEditUrl}" type="button">Cập nhật dữ liệu</a>--%>
                                ...
                                <div class="table-btn-controls">
                                    <div class="pull-right tableTools-container">
                                        <div class="dt-buttons btn-overlap btn-group">
                                            <a flag="info"
                                                    <c:url value="/admin-guideline-listen-edit.html" var="editUrl">
                                                        <c:param name="urlType" value="url_edit" />
                                                    </c:url>
                                               class="dt-button buttons-colvis btn btn-white btn-primary btn-bold" href="${editUrl}"
                                               title="<fmt:message key='label.listenguideline.add' bundle='${lang}'/>"
                                            >
                                                        <span>
                                            ...
                                            <button type="button"
                                                    ...
                                                    id="deleteAll" disabled onclick="showWarningBeforeDelete()"
                                                    data-toggle="tooltip"
...
<%--                                        </c:url>--%>
                                        <c:url var="urlEdit" value="/admin-guideline-listen-edit.html">
                                            <c:param name="urlType" value="url_edit" />
                                            <c:param name="pojo.listenGuidelineId" value="${tableList.listenGuidelineId}" />
                                        </c:url>
                                        <a class="btn btn-sm btn-primary btn-edit" href="${urlEdit}" data-toggle="tooltip" title="<fmt:message key='label.listenguideline.update' bundle='${lang}'/>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
...
<script>
   ...
   function showWarningBeforeDelete() {
        showAlert(function () {
            // $('#urlType').val('url_list');
